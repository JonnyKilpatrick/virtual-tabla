...
{ 
  ...
  public DrumSynthNote(Synthesizer synth, LineOut lineOut)
  {
    ...
    {  
      ...
      Function karplusStrong = new Function()
      {
        ...
        private double newSample2 = 0;
        private double sample2 = 0;
        
        private double blendFactor = 1;
        ...
        public double evaluate(double x)
        {
          ...
          newSample2 = shorteningFactor * ((stretchingFactorTakeOne * sample2) + (stretchingFactor * lastSample2));
          lastSample2 = sample2;
          
          double result = (blendFactor * newSample) + ((1-blendFactor) * newSample2);
          
          if(blendFactor>=0)
          {
            blendFactor -= 0.000001;
          }
   ...
   */
   ...
   public void playNote(double fundimentalFrequency, double amplitude, double duration, double q)
   {
     ...
     buffer = new CircularBuffer(numSamples, numSamples-15, numSamples-25, initialWaveTable);
